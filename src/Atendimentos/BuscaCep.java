...
public class BuscaCep extends javax.swing.JDialog {
    ...
    public BuscaCep(java.awt.Frame parent, boolean modal) {
        ...
        String[] aheaders = { "Logradouro", "Nomeslog", "Endere��o", "Bairro", "Cidade", "Uf", "Cep" };
        int[] widths = { 0, 0, 500, 250, 250, 100, 150 };
        String[] aligns = { "L", "L", "L", "L", "L", "L", "L" };
        newTable.InitTable(this.tblCEPS, aheaders, widths, aligns, true);
    ...
    TableControl.Clear(this.tblCEPS);
    
    String[] cbusca = ctexto.split(",");
    String tsql = "";
    if (cbusca.length == 1) {
      tsql = "select e.logradouro, e.nomeslog, e.nomeclog, b.nome as bairro, c.nome as cidade, b.uf, e.cep  from cep_enderecos e, cep_bairros b, cep_cidades c where (e.bairro_id = b.id) and (e.cidade_id = c.id) and b.uf = 'RJ' and TRANSLATE(UPPER(nomeslog), '��������������������������������������������������������������������������������������������', 'aeiouaeiouaoaeiooaeioucAEIOUAEIOUAOAEIOOAEIOUC') like TRANSLATE('%" + cbusca[0].toUpperCase().trim() + "%', '��������������������������������������������������������������������������������������������', 'aeiouaeiouaoaeiooaeioucAEIOUAEIOUAOAEIOOAEIOUC') ORDER BY Upper(c.nome), Upper(e.nomeslog);";
    } else {
      tsql = "select e.logradouro, e.nomeslog, e.nomeclog, b.nome as bairro, c.nome as cidade, b.uf, e.cep  from cep_enderecos e, cep_bairros b, cep_cidades c where (e.bairro_id = b.id) and (e.cidade_id = c.id) and b.uf = 'RJ' and TRANSLATE(UPPER(nomeslog), '��������������������������������������������������������������������������������������������', 'aeiouaeiouaoaeiooaeioucAEIOUAEIOUAOAEIOOAEIOUC') like TRANSLATE('%" + cbusca[0].toUpperCase().trim() + "%', '��������������������������������������������������������������������������������������������', 'aeiouaeiouaoaeiooaeioucAEIOUAEIOUAOAEIOOAEIOUC') and TRANSLATE(UPPER(c.nome), '��������������������������������������������������������������������������������������������', 'aeiouaeiouaoaeiooaeioucAEIOUAEIOUAOAEIOOAEIOUC') like TRANSLATE('%" + cbusca[1].toUpperCase().trim() + "%', '��������������������������������������������������������������������������������������������', 'aeiouaeiouaoaeiooaeioucAEIOUAEIOUAOAEIOOAEIOUC') ORDER BY Upper(c.nome), Upper(e.nomeslog);";
    }
    ResultSet tbcep = this.conn.AbrirTabela(tsql, 1007);
    try
    {
      this.tam = DbMain.RecordCount(tbcep);
      this.n = 1;
      this.jbarra.setValue(0);
      this.jbarra.setVisible(true);
      while (tbcep.next())
      {
        new Thread()
        {
        ...
        newTable.add(this.tblCEPS, linha);
    ...
    private void tblCEPSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCEPSMouseClicked
        int row = this.tblCEPS.getSelectedRow();
        if (row < 0) {
            this.dados = null;
        } else if (evt.getClickCount() == 2)  {
            String slogra = this.tblCEPS.getModel().getValueAt(row, 0).toString();
            String sender = this.tblCEPS.getModel().getValueAt(row, 1).toString();
            String sbairr = this.tblCEPS.getModel().getValueAt(row, 3).toString();
            String scidad = this.tblCEPS.getModel().getValueAt(row, 4).toString();
            String sestad = this.tblCEPS.getModel().getValueAt(row, 5).toString();
            String scep = this.tblCEPS.getModel().getValueAt(row, 6).toString();
            this.dados = new Object[] { slogra, sender, sbairr, scidad, sestad, scep };
